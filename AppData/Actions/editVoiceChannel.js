module.exports = {
  ...
  async run(values, message, client, bridge) {
    ...
    if (values.userLimit == 'Change') {
      edits.userLimit = bridge.transf(values.limit);
    }
    ...
    if (values.status == 'Change') {
      channel.setStatus(bridge.transf(values.statusUpdate));
    }
